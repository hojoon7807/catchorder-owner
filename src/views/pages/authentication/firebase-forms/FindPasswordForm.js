...
const FindPasswordForm = (props, { ...others }) => {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://52.78.243.176/web/account/password', data, {
                headers: {
    ...
    return (
        <>
            <form noValidate onSubmit={onSubmit}>
                ...
                <FormControl fullWidth className={classes.loginInput}>
                    <InputLabel htmlFor="outlined-adornment-phone-login">이메일</InputLabel>
                    <OutlinedInput
